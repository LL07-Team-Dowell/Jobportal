...
const ThreadItem = ({ status }) => {
  ...
  const filteredData = teamNamesArray.filter(
    (item) => item.admin_team === true
  );
                      ...
                      <div className="team-screen-threads-container">
                        ...
                        <div className="comments-section">
                          <p className="comments">
                            ...
                            &bull;
                            <span onClick={() => handlCommentClick(thread._id)}>
                              {thread?.comments.data.length} Comments
                            </span>
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="comment-action">
                      {showComment[thread._id] && (
                        <ThreadComment
                          ...
                          updateComments={(newComment) =>
                            handleUpdateCommentState(newComment, thread._id)
                          }
                        />
                      )}
                    </div>
                          ...
                          <div className="progress">
                            ...
                            {thread.current_status === "Created" ? (
                              <ReactTooltip
                                id="inprogress"
                                place="bottom"
                                content="Update Status to inprogress"
                              />
                            ) : (
                              <ReactTooltip
                                id="inprogress"
                          ...
                          <div className="progress">
                            ...
                            thread.current_status == "In progress" ? (
                              ...
                              <div
                                ...
                                onClick={() =>
                                  toast.warning("You can't update the status")
                                }
                              ></div>
                            )}
                            <ReactTooltip
