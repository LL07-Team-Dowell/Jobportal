...
export const createThread = async (data) => {
  console.log(data);
  return await currentBackendAxiosInstance.post("create_thread/", data);
};
...
export const updateThread = async (data) => {
  return await currentBackendAxiosInstance.patch(`update_thread/`, data);
};

export const postComment = async (data) => {
  return await currentBackendAxiosInstance.post("create_comment/", data);
};
